...
const Footer = () => {
  return (
    <footer className="bg-[#1E3A1E] text-white py-10 md:pt-15">
      <div className="px-4 grid container mx-auto grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="mt-2 text-sm text-gray-300">
            A Food Sharing Platform to reduce food waste and help
            hungry people.
          </p>
        </div>
      ...
      {/* Bottom */}
      <div className="mt-10 border-t border-gray-400 pt-4 text-center text-gray-200 text-sm">
