...
const Login = () => {
  ...
  return (
    <section className="container mx-auto max-w-2xl min-h-screen py-10 px-4">
      <div className="p-7 md:p-10 bg-green-300 rounded-lg shadow-lg">
        ...
        <div className="flex justify-center">
          <button onClick={handleLoginWithGoogle} className="btn btn-primary text-base-100">
      ...
      <div className="text-center mt-5">
        <Link to="/" className="btn btn-primary border-0 text-base-100">
          <TbArrowBackUp />
          Go to home
        </Link>
      </div>
